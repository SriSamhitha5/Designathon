...
employees = [
    Employee("karthick", "1000070232", "password", "E002", False),
    ...
    Employee("Nikhil", "1000078187", "password", "E002", False),
    Employee("kavya", "1000071574", "password", "E002", False),
    Employee("Samhitha", "2000078164", "password", "E002", False),
...
hr_data = [
    HRData("1000070232", True, 5, 10, 8,30),
    HRData("E002", True, 3, 8, 7,55),
    HRData("E003", True, 5, 10, 8,65),
    HRData("E004", True, 3, 8, 7,70),
    HRData("1000078187", True, 5, 10, 8, 65),
    HRData("1000071574", True, 5, 10, 8, 65),
    HRData("2000078164", True, 5, 10, 8, 65),
